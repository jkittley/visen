...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        def get_data(filter_str, start, end, open_or_not):
            ...
            # Load sensors
            if filter_str:
                profiles = Sensor_profile.objects.filter(longname__icontains=filter_str)
            else:
        ...
        data = get_data(options['filter'],start,end,options['open_or_not'])
